...
('user-001','alice','alice@bookhive.test','x-hash-1','2026-01-01 10:00:00'),
('user-002','bob','bob@bookhive.test','x-hash-2','2026-01-02 10:00:00'),
('user-003','carol','carol@bookhive.test','x-hash-3','2026-01-03 10:00:00');
...
('order-001','user-001',36.97,'COMPLETED','2026-02-01 12:00:00'),
('order-002','user-001',18.99,'COMPLETED','2026-02-10 12:00:00'),
('order-003','user-002',29.98,'PENDING','2026-02-15 12:00:00');
...
('cart-001','user-001','book-005',1,'2026-03-01 09:00:00'),
('cart-002','user-002','book-002',3,'2026-03-02 09:00:00');

-- Marketplace listings
INSERT INTO marketplace_listings (listing_id, seller_id, book_id, `condition`, price, listed_at, status) VALUES
('listing-001','user-001','book-004','USED_GOOD',6.50,'2026-03-05 08:00:00','ACTIVE'),
('listing-002','user-002','book-007','LIKE_NEW',12.00,'2026-03-06 08:00:00','ACTIVE'),
('listing-003','user-003','book-001','USED_FAIR',4.00,'2026-03-07 08:00:00','SOLD');
